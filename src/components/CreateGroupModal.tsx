    ...
    <div className="fixed inset-0 bg-void/80 flex items-center justify-center z-50 p-4">
      <div className="modal-panel rounded-2xl max-w-md w-full max-h-[90vh] overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto max-h-[calc(90vh-80px)]">
          <div>
            <label htmlFor="creategroupmodal-group-name" className="block text-sm font-medium text-ink/75 mb-2">
              Group Name *
            </label>
          ...
          <div>
            <label htmlFor="creategroupmodal-description" className="block text-sm font-medium text-ink/75 mb-2">
              Description
            </label>
          ...
          <div>
            <label htmlFor="creategroupmodal-subject-optional" className="block text-sm font-medium text-ink/75 mb-2">
              Subject (Optional)
            </label>
          ...
          <div className="flex items-center justify-between p-4 bg-surface rounded-xl">
            <div className="flex items-center space-x-3">
              ...
              {formData.isPrivate
                ? <Lock className="text-ink/75" size={20} />
                : <Globe className="text-ink/75" size={20} />}
              <div>
          ...
          <div>
            <div id="creategroup-add-friends" className="block text-sm font-medium text-ink/75 mb-3">
              Add Friends ({formData.selectedMembers.length} selected)
            </div>
            <div role="group" aria-labelledby="creategroup-add-friends" className="max-h-48 overflow-y-auto border border-hairline-soft rounded-lg">
              {friends.length === 0 ? (
